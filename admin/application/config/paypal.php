 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'swebsite2013@gmail.com' : '';
$config['APIPassword'] = $config['Sandbox'] ? 'shyma811' : '';
$config['APISignature'] = $config['Sandbox'] ? '' : '';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? 'swebsite2013@gmail.com' : '';
$config['PayFlowPassword'] = $config['Sandbox'] ? 'shyma811' : '';
$config['PayFlowVendor'] = $config['Sandbox'] ? 'SANDBOX_VENDOR_GOES_HERE' : '';
$config['PayFlowPartner'] = $config['Sandbox'] ? 'SANDBOX_PARTNER_GOES_HERE' : '';
 ...
 */
$config['DeveloperEmailAccount'] = 'swebsite2013@email.com';
