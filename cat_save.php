          ...
          <table class="table table-striped table-bordered bootstrap-datatable datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="<?php echo base_url(); ?>/images/<?php echo $row['img']; ?>"  class="thumbnail" width="100" height="100" /></td>
               
               
               
                <td><a class="btn btn-danger" href="<?php echo base_url('admin/remove_confirm_store/'.$row['pk_id']) ?>"> <i class="fa fa-trash-o "></i> </a></td>
              </tr>
              <?php $c++; } ?>
            </tbody>
          </table>
